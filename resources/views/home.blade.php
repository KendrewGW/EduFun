...
<html lang="en">
    ...
    <section class="top-image">
        <img src="{{ asset('image/young-students-learning-library-bookshelves.jpg') }}" alt="" class="img-fluid top-image w-100"> 
    </section>
        ...
        @foreach ($contents as $content)
            <div class="container">
                <div class="d-flex mt-5">
                    <div class="row-7">
                        <img src="{{ asset('image/young-students-learning-library-bookshelves.jpg') }}" alt="" class="img-fluid">
                    </div>
