...
<body>
    <nav class="container-fluid bg-white shadow d-flex justify-content-between align-items-center p-4 pt-3 pb-3">
        ...
        <div class="d-flex">
            ...
            <a href="writers" class="ms-5 text-primary">Writers</a>
            <a href="aboutus" class="ms-5">About Us</a>
            <a href="popular" class="ms-5">Popular</a>
        </div>
    </nav>

    <div class="container-fluid justify-content-center align-items center p-5">
        <h1 class="fw-bold mb-5">Our Writers</h1>
        <div class="d-flex text-center">
            @foreach ($writers as $w)
            <div class="col">
                <img src="{{ $w->image }}" alt="profile image" class="mt-5">
